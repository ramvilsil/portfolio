                ...
                <div className="flex justify-evenly items-center flex-col text-center portrait:mb-6">
                    ...
                    <div className="flex justify-between mb-10 portrait:flex-col portrait:mb-0">
                        ...
                        <div className="w-full flex flex-col m-2 portrait:flex-row-reverse items-center portrait:justify-start">
                            ...
                            {/* Project Name */}
                            <div className="portrait:text-left portrait:text-sm portrait:w-16 portrait:mr-16">Portfolio Website</div>
                        ...
                        <div className="w-full flex flex-col m-2 portrait:flex-row-reverse items-center portrait:justify-start">
                            ...
                            {/* Project Name */}
                            <div className="portrait:text-left portrait:text-sm portrait:w-16 portrait:mr-16">Small Business Web&nbsp;Page</div>
                        ...
                        <div className="w-full flex flex-col m-2 portrait:flex-row-reverse items-center portrait:justify-start">
                            ...
                            {/* Project Name */}
                            <div className="portrait:text-left portrait:text-sm portrait:w-16 portrait:mr-16">Theatre CMS</div>
                    ...
                    */}
                    ...
                    <div className="flex justify-between mb-10 portrait:flex-col portrait:mb-0">
                        ...
                        <div className="w-full flex flex-col m-2 portrait:flex-row-reverse items-center portrait:justify-start">
                            ...
                            {/* Project Name */}
                            <div className="portrait:text-left portrait:text-sm portrait:w-16 portrait:mr-16">Calculator Web&nbsp;App</div>
                        ...
                        <div className="w-full flex flex-col m-2 portrait:flex-row-reverse items-center portrait:justify-start">
                            ...
                            {/* Project Name */}
                            <div className="portrait:text-left portrait:text-sm portrait:w-16 portrait:mr-16">To-Do Web&nbsp;App</div>
